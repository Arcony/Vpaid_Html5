...
VpaidVideoPlayer.prototype.initAd = function(
  ...
  //console.log(this.parameters_.overlay);
...
VpaidVideoPlayer.prototype.startAd = function() {
  ...
  img.src = "http://slpubmedias.tf1.fr/test_nocache/test_jf/Vpaid/Test/barreSpot.png";
  this.slot_.appendChild(img);
  var imgParent = img.parentElement;
  img.id="overlay";
  imgParent.style.width="100%";
  imgParent.style.height="100%";
    imgParent.style.zIndex="5";
  img.style.width="100%";
    img.style.height="75px";
  img.style.marginTop="40%";
  img.addEventListener('click', OpenOverlay , false);

    var TestOverlay = document.createElement('img');
    TestOverlay.src = "http://slpubmedias.tf1.fr/test_nocache/test_jf/Vpaid/Test/paneau.jpg";
    this.slot_.appendChild(TestOverlay);
    ...
    {
      console.log("OVERLAY");
        TestOverlay.style.visibility="visible";

        TestOverlay.addEventListener('click', this.overlayOnClick_.bind(this), false);
    }
